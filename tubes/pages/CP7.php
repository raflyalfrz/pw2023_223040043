                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4  d-sm-block  d-md-block  d-lg-block">
                        <div class="card border-0 bg-light mb-2">
                            <img src="../img/Minyak telon.jpg" class="card-img-top img-fluid" alt="My Baby Minyak Telon 150 ml" style="object-fit: contain">
                        </div>
                    </div>
                        ...
                        <table class="table no-border">
                            <tbody>
                                <tr>
                                    <th>Nama</th>
                                    <td>:</td>
                                    <td>MY BABY MINYAK TELON 150 ML</td>
                                </tr>
                                <tr>
                                    <th>Harga</th>
                                    <td>:</td>
                                    <td>Rp. 35.000/BOTOL</td>
                                </tr>
                                <tr>
                                    <th>Dosis</th>
                                    <td>:</td>
                                ...
                                <tr>
                                    <th>Deskripsi</th>
                                    <td>:</td>
                                    <td>My Baby Minyak Telon adalah minyak obat bersertifikat halal yang berfungsi untuk memberikan kehangatan pada tubuh bayi, terutama ketika cuaca dingin atau sehabis memandikan bayi. Tidak hanya itu, formula herbal yang terkandung pada minyak telon ini juga ampuh mencegah gigitan nyamuk.
                                        My Baby Minyak Telon mengandung minyak serai, minyak bunga kamomil, minyak adas, minyak kayu putih, dan minyak kelapa. Minyak kayu putih dan minyak adas memiliki sifat antiinfeksi yang terjadi di tubuh atau kulit. Selain itu, kandungan sineol di dalam minyak kayu putih dapat meredakan nyeri.
                                        Sementara, minyak serai bekerja efektif mencegah gigitan serangga karena baunya yang menyengat dan tidak disukai nyamuk. Namun, wangi serai dapat menjadi aromaterapi bagi manusia. Tersedia sekarang di Toko SehatQ, harga My Baby Minyak Telon pasti lebih terjangkau!</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
