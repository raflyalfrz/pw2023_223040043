    ...
    <section class="shop py-5" id="produk">
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-lg-3 col-6 text-center">
                    <div class="card border-0 bg-light mb-2">
                        ...
                        <div class="card-body">
                            ...
                            <a href="../pages/CP1.php" class="btn btn-primary ">Lihat detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6 text-center">
                    <div class="card border-0 bg-light mb-2">
                        <img src="../img/Laica digital.png" class="card-img-top img-fluid" alt="lAICA DIGITAL THERMOMETER" style="object-fit: contain">
                        <div class="card-body">
                            <h6 class="card-title">LAICA DIGITAL THERMOMETER</h6>
                            <p class="card-text">Rp. 133.200/PC</p>
                            <a href="../pages/CP2.php" class="btn btn-primary ">Lihat detail</a>
                        </div>
                    </div>
                </div>
            </div>
