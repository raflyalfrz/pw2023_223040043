                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4  d-sm-block  d-md-block  d-lg-block">
                        <div class="card border-0 bg-light mb-2">
                            <img src="../img/Tempra drops.png" class="card-img-top img-fluid" alt="TEMPRA DROPS 15 ML/OBAT DEMAM NYERI ANAK & BAYI" style="object-fit: contain">
                        </div>
                    </div>
                        ...
                        <table class="table no-border">
                            <tbody>
                                <tr>
                                    <th>Nama</th>
                                    <td>:</td>
                                    <td>TEMPRA DROPS 15 ML/OBAT DEMAM NYERI ANAK & BAYI</td>
                                </tr>
                                <tr>
                                    <th>Harga</th>
                                    <td>:</td>
                                    <td>Rp. 50.350/BOTOL</td>
                                </tr>
                                <tr>
                                    <th>Dosis</th>
                                    <td>:</td>
                                    <td>Gunakan sesuai anjuran dokter, bila perlu satu dosis setiap 5 jam, namun tidak lebih dari 5 kali sehari. Bayi usia dibawah 3 bulan : sesuai anjuran dokter. Bayi usia 3-9 bulan 0.8 ml. Bayi usia 10-24 bulan 1.2 ml.</td>
                                </tr>
                                <tr>
                                    <th>Deskripsi</th>
                                    <td>:</td>
                                    <td>Tempra Drops 15 mL, tiap 0.8 mL mengandung: Paracetamol 80 mg. Tempra Drops digunakan untuk meredakan demam, rasa sakit dan nyeri ringan, sakit kepala dan sakit gigi.
                                    </td>
                                </tr>
                            </tbody>
                        </table>
