...
<body>
    ...
    <!-- ............................Bagian Produk........................ -->
    <section class="shop py-5" id="vitamin">
        <div class="container">
            <div class="row py-5">
            ...
            <div class="row ">
                ...
                <div class="col-lg-3 col-6 text-center">
                    <div class="card border-0 bg-light mb-2">
                        ...
                        <div class="card-body">
                            ...
                            <a href="../pages/CP5.php" class="btn btn-primary ">Lihat detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6 text-center">
                    <div class="card border-0 bg-light mb-2">
                        <img src="../img/Sakatonik.png" class="card-img-top img-fluid" alt="SAKATONIK LIVER SIRUP" style="object-fit: contain">
                        <div class="card-body">
                            <h6 class="card-title">SAKATONIK LIVER SIRUP</h6>
                            <p class="card-text">Rp. 12.851/BOTOL</p>
                            <a href="../pages/CP6.php" class="btn btn-primary ">Lihat detail</a>
                        </div>
                    </div>
                </div>
            </div>
