                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4  d-sm-block  d-md-block  d-lg-block">
                        <div class="card border-0 bg-light mb-2">
                            <img src="../img/Laica digital.png" class="card-img-top img-fluid" alt="LAICA DIGITAL THERMOMETER TH3302" style="object-fit: contain">
                        </div>
                    </div>
                        ...
                        <table class="table no-border">
                            <tbody>
                                <tr>
                                    <th>Nama</th>
                                    <td>:</td>
                                    <td>LAICA DIGITAL THERMOMETER TH3302</td>
                                </tr>
                                <tr>
                                    <th>Harga</th>
                                    <td>:</td>
                                ...
                                <tr>
                                    <th>Deskripsi</th>
                                    <td>:</td>
                                    <td>Termometer Digital Laica TH 3302 merupakan alat pengukur suhu tubuh dengan layar
                                        LCD untuk menampilkan hasil pengukuran yang menawarkan akurasi, keamanan dan kecepatan
                                        dalam pengukuran temperatur, dengan ujung tip yang fleksibel menambah tingkat kenyamanan
                                        pada saat pengukuran.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
