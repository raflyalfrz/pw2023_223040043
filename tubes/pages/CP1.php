                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4  d-sm-block  d-md-block  d-lg-block">
                        <div class="card border-0 bg-light mb-2">
                            <img src="../img/Aicare infrared.png" class="card-img-top img-fluid" alt="AICARE INFRARED THERMOMETER" style="object-fit: contain">
                        </div>
                    </div>
                        ...
                        <table class="table no-border">
                            <tbody>
                                <tr>
                                    <th>Nama</th>
                                    <td>:</td>
                                    <td>AICARE INFRARED THERMOMETER</td>
                                </tr>
                                <tr>
                                    <th>Harga</th>
                                    <td>:</td>
                                ...
                                <tr>
                                    <th>Deskripsi</th>
                                    <td>:</td>
                                    <td>Aicare Infrared Termometer dengan tingkat akurasi yang tinggi dan pengoperasian yang sangat mudah cukup mengarahkan sinar infrared ke tubuh dengan jarak 5-15 cm. hanya akan butuh waktu 0.5 detik hasil pengukuran akan muncul di layar LCD termometer.</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
