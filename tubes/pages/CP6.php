                        ...
                        <table class="table no-border">
                            <tbody>
                                <tr>
                                    <th>Nama</th>
                                    <td>:</td>
                                    <td>SAKATONIK LIVER SIRUP
                                    </td>
                                </tr>
                                <tr>
                                    <th>Harga</th>
                                    <td>:</td>
                                    <td>Rp. 12.851/BOTOL</td>
                                </tr>
                                <tr>
                                    <th>Dosis</th>
                                    <td>:</td>
                                    <td>Dewasa : 1-2 kali sehari 1 sendok makan. Anak-anak : 1-2 kali sehari 1-2 sendok teh. Disertai dengan minum segelas air putih.
                                    </td>
                                </tr>
                                <tr>
                                    <th>Deskripsi</th>
                                    <td>:</td>
                                    <td>100 ML
                                        Sakatonik Liver merupakan salah
                                        satu produk penyuplai vitamin dan
                                        mineral dari luar tubuh.
                                    </td>
                                </tr>
                            </tbody>
                        </table>
