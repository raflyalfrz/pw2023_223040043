                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4  d-sm-block  d-md-block  d-lg-block">
                        <div class="card border-0 bg-light mb-2">
                            <img src="../img/Cdr .png" class="card-img-top img-fluid" alt="CDR 15 TABLET EFFERVESCENT/ SUPLEMEN KESEHATAN TULANG & SENDI" style="object-fit: contain">
                        </div>
                    </div>
                        ...
                        <table class="table no-border">
                            <tbody>
                                <tr>
                                    <th>Nama</th>
                                    <td>:</td>
                                    <td>CDR 15 TABLET EFFERVESCENT/ SUPLEMEN KESEHATAN TULANG & SENDI
                                    </td>
                                </tr>
                                <tr>
                                    <th>Harga</th>
                                ...
                                <tr>
                                    <th>Dosis</th>
                                    <td>:</td>
                                    <td>1 tablet effervescent per hari atau menurut petunjuk dokter.
                                    </td>
                                </tr>
                                <tr>
                                    <th>Deskripsi</th>
                                    <td>:</td>
                                    <td>Calcium D Redoxon merupakan suplemen yang mengandung Kalsium, Vitamin C, Vitamin D dan Vitamin B6 agar tulang sehat pada orang dewasa serta membantu memenuhi kebutuhan kalsium pada ibu hamil dan menyusui. Juga diperlukan untuk masa pertumbuhan, masa penyembuhan, serta gangguan penyerapan makanan. Tulang kuat diperlukan untuk menunjang aktivitas sehari-hari. Kekuatan tulang dapat dipersiapkan sejak dini, yakni dengan memenuhi kebutuhan kalsium anda setiap hari. CDR mengandung kalsium dan vitamin penting lainnya yang berperan dalam proses pembentukan tulang kuat dan sehat. CDR, dengan rasa jeruk segar membantu memenuhi kebutuhan kalsium setiap hari bila perlu agar tulang tetap kuat kini dan nanti.
                                    </td>
                                </tr>
                            </tbody>
                        </table>
