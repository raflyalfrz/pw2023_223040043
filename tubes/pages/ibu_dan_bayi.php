    ...
    <section class="shop py-5" id="produk">
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-lg-3 col-6 text-center">
                    <div class="card border-0 bg-light mb-2">
                        ...
                        <div class="card-body">
                            ...
                            <a href="../pages/CP7.php" class="btn btn-primary ">Lihat detail</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-6 text-center">
                    <div class="card border-0 bg-light mb-2">
                        <img src="../img/Vitaflow botol susu.png" class="card-img-top img-fluid" alt="VITAFLOW BOTOL SUSU" style="object-fit: contain">
                        <div class="card-body">
                            <h6 class="card-title">VITAFLOW BOTOL SUSU</h6>
                            <p class="card-text">Rp. 34.000</p>
                            <a href="../pages/CP8.php" class="btn btn-primary ">Lihat detail</a>
                        </div>
                    </div>
                </div>
            </div>
