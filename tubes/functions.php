...
function registrasi_customer($data)
{
    ...
    // cek username sudah ada atau belum
    $result = mysqli_query($conn, "SELECT nama FROM customer WHERE nama = '$username'");
    ...
    // tambahkan userbaru ke database
    mysqli_query($conn, "INSERT INTO customer VALUES(NULL, '$username', '$password')");
